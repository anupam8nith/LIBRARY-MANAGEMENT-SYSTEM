//ANUPAM KUMAR
//ROLL.NO: 195050
//NIT HAMIRPUR, 4th Sem, CSE.

//   OBJECTIVE : To manage the details of books issued to students ,avialable books in library and to store registered student .
    ...
    while(fp.read((char*)&st,sizeof(student)) && found==0)
       {
        if(strcmp(st.retadmno(),sn)==0)
        {
               ...
               if(strcmp(bk.retbno(),st.retstbno())==0)
            {
                ...
                {
                   fine=(day-15)*1;
                   cout<<"\n\nFine has to deposited Rs. "<< fine << " ,for late deposited \n" ;
                }
                    st.resettoken();
                    int pos=-1*sizeof(st);
                    fp.seekp(pos,ios::cur);
...
//***************************************************************
//         Menu Function for Adminstrator
//****************************************************************
